...
class TableChucVu extends Component<Props, State> {
                                                        ...
                                                        <form role="form">
                                                            <div className="form-group mb-3">
                                                                <div className="input-group input-group-merge input-group-alternative">
                                                                    ...
                                                                    <input className="form-control" placeholder="Mã chức vụ" type="url" />
                                                                </div>
                                                            </div>
                                                            <div className="form-group">
                                                                <div className="input-group input-group-merge input-group-alternative">
                                                                    ...
                                                                    <input className="form-control" placeholder="Tên chức vụ" type="text" />
                                                                </div>
                                                            </div>
                    ...
                    <div className="table-responsive">
                        <table className="table align-items-center table-flush table-striped">
                            <thead className="thead-light">
                                <tr>
                                    <th></th>
                                    <th scope="col" className="sort" data-sort="codeChucVu">Mã chức vụ</th>
                                    <th></th>
                                    <th></th>
                                    <th scope="col" className="sort" data-sort="nameChucVu">Tên chức vụ</th>
                                    <th></th>
                                    <th></th>
                                    <th></th>
                                    <th></th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td className="table-user">
                                        <span className="text-muted">CV0001</span>
                                    </td>
                                    <td></td>
                                    <td></td>
                                    <td>
                                        <span className="text-muted">Trưởng phòng</span>
                                    </td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
